class Cube2 {
  ...
  Cube2( color c1, color c2, color c3, color c4, color c5, color c6, PImage tex1, PImage tex2, PImage tex3, PImage tex4, PImage tex5, PImage tex6) {
    this.t = 1;
    this.texture1 = tex1;
    this.texture2 = tex2;
    this.texture3 = tex3;
